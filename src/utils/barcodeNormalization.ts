...
export function normalizeBarcode(barcode: string): string[] {
  ...
  if (cleaned.length === 8) {
    ...
    // EAN-8 to EAN-13: 94 + 000 + EAN-8 (5 digits) + check digit
    ...
    // Try AU prefix (93) - less common for NZ products
    // Only add if we're not sure about country
