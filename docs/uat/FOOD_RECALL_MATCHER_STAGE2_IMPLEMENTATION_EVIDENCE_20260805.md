...
| Corrective commit (this pass) | _filled at commit time_ |

Immutable links (corrective):

- Commit: `https://github.com/TrueScanOnline/TruScore/commit/<CORRECTIVE_SHA>`
- Tree: `https://github.com/TrueScanOnline/TruScore/tree/<CORRECTIVE_SHA>`
