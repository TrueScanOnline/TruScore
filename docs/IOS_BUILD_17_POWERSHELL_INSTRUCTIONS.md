# iOS Build 17 – PowerShell Instructions (User Testing / App Store Connect)

**Target:** iPhone 11 user testing  
**Build number:** 17 (incremented from 16)  
...
- EAS will use **build number 17** and **version 10.0.0** from `app.config.js`.
...
| Item | Value |
|------|--------|
| **iOS build number** | 17 (`app.config.js` → `expo.ios.buildNumber`) |
