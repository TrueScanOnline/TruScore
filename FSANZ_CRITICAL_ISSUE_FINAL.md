# FSANZ Critical Issue - Final Report
...
Even after disabling these scripts and running `scripts\fixNZFCDDatabase.js`, the database is still broken. The database file has `rawData` with "__EMPTY" fields, which is a definitive signature of XLSX library reading Excel files with empty columns.
