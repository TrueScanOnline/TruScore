 ...
 * Generates NZFCD from text file and locks it
 */
...
const LOCK_FILE = path.join(__dirname, '..', 'backend', 'vercel', 'data', '.nzfcd.lock');

console.log('FINAL NZFCD FIX');
console.log('='.repeat(80));

// Create lock file to prevent overwrites
fs.writeFileSync(LOCK_FILE, JSON.stringify({ locked: true, timestamp: Date.now() }), 'utf8');
