 ...
 * Directly reads text file, generates database, writes it, and verifies
 */
...
console.log('ABSOLUTE FINAL NZFCD FIX');
...
console.log(`✅ Text file: ${TEXT_FILE}\n`);
...
// Step 6: Delete old file and write new one
