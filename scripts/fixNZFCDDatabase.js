/**
 * Fix NZFCD Database - Direct from text file
 * This script will definitely work
 */
...
// After filtering copyright, structure should be:
// lines[0] = Header row 1 (column names like "FoodID", "Food Name")
// lines[1] = Header row 2 (units)
// lines[2+] = Data rows
...
// Step 6: Delete old and write new
